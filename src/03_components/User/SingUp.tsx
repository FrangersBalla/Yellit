...
export function SingUp({setSignUp}: SingUpProps) {
  ...
  return (
    <div className="bg-black max-h-[90vh] overflow-y-auto rounded-xl p-4 flex flex-col md:mt-16 lg:mr-60">
      <div className="w-full bg-zinc-950 rounded-lg p-6 shadow-lg">
        <h1>Welcome,<br /></h1>
