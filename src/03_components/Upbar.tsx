  ...
  return (
    <header className="fixed top-0 w-full p-4 rounded-b-xl z-50 bg-black">
      <div className="h-8 mx-auto flex items-center gap-4">
        <button onClick={()=>{setPage(0); setOldPage(0); window.location.reload()}} className="ml-5 cursor-pointer"><h1 className="ml-5 font-sans text-3xl text-white font-black tracking-tighter whitespace-nowrap">
          yellit
        </h1></button>
